...
class DeepClassifier:
    ...
    def __init__(self, dae_lr=0.001, nn_lr=0.01, dae_decay=0.9, nn_decay=0.99, L2 = 0, batch_size=512,
    ...
    def build_graph(self, inp):
        ...
        with tf.name_scope('DAE'):
            ...
            with tf.name_scope('layer1'):
                ...
                dae_layer1 = tf.nn.sigmoid(dae_layer1)
        ...
        with tf.name_scope('NN'):
            ...
            with tf.name_scope('layer0'):
                ...
                a0 = tf.nn.elu(tf.add(tf.matmul(nn_inp, nn_w0), nn_b0), name='output')
            ...
            with tf.name_scope('layer1'):
                ...
                a1 = tf.nn.elu(tf.add(tf.matmul(nn_layer0, nn_w1), nn_b1), name='output')
